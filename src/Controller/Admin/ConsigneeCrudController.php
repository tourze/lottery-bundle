 ...
 * 收货信息管理控制器
 *
 * @template TEntity of Consignee
 * @extends AbstractCrudController<TEntity>
 */
#[AdminCrud(
    routePath: '/lottery/consignee',
    routeName: 'lottery_consignee',
)]
final class ConsigneeCrudController extends AbstractCrudController
{
    /**
