...
#[AsPermission(title: '口令')]
#[Deletable]
#[ORM\Entity(repositoryClass: WatchwordRepository::class)]
#[ORM\Table(name: 'lottery_watchword', options: ['comment' => '口令'])]
class Watchword
{
    #[Filterable]
    #[IndexColumn]
    ...
    #[ListColumn]
    #[FormField]
    #[ORM\Column(type: Types::STRING, length: 100, options: ['comment' => '口令'])]
    private ?string $code = null;

    #[ListColumn]
    #[FormField]
    #[ORM\Column(type: Types::INTEGER, nullable: true, options: ['comment' => '最大分发次数'])]
